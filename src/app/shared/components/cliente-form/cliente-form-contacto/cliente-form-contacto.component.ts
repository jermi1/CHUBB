...
@Component({
  selector: 'vex-cliente-form-contacto',
  templateUrl: './cliente-form-contacto.component.html',
  styleUrls: ['./cliente-form-contacto.component.scss'],
  animations: [fadeInRight400ms, stagger40ms]
})


export class ClienteFormContactoComponent implements OnInit {
