...
@Component({
  selector: 'vex-cliente-form-vinculados',
  templateUrl: './cliente-form-vinculados.component.html',
  styleUrls: ['./cliente-form-vinculados.component.scss'],
  animations: [fadeInRight400ms, stagger40ms]
})


export class ClienteFormVinculadosComponent implements OnInit {
