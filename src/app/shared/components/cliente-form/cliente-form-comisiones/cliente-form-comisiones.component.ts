...
@Component({
  selector: 'vex-cliente-form-comisiones',
  templateUrl: './cliente-form-comisiones.component.html',
  styleUrls: ['./cliente-form-comisiones.component.scss'],
  animations: [fadeInRight400ms, stagger40ms]
})


export class ClienteFormComisionesComponent implements OnInit {
