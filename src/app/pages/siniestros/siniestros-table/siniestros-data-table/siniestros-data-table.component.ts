...
@Component({
  selector: 'vex-siniestros-data-table',
  templateUrl: './siniestros-data-table.component.html',
  styleUrls: ['./siniestros-data-table.component.scss'],
  providers: [
    {
...
export class SiniestrosDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: Siniestro['id']) {
