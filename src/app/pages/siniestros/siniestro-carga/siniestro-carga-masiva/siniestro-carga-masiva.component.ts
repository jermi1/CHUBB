...
@Component({
  selector: 'vex-siniestro-carga-masiva',
  templateUrl: './siniestro-carga-masiva.component.html',
  styleUrls: ['./siniestro-carga-masiva.component.scss']
})
export class SiniestroCargaMasivaComponent implements OnInit {
