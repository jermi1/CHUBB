...
@Component({
  selector: 'vex-siniestro-edit',
  templateUrl: './siniestro-edit.component.html',
  styleUrls: ['./siniestro-edit.component.scss']
})


export class SiniestroEditComponent implements OnInit {
