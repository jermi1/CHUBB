...
@Component({
  selector: 'vex-ccomisiones-cierres-show-details',
  templateUrl: './comisiones-cierres-show-details.component.html',
  styleUrls: ['./comisiones-cierres-show-details.component.scss'],
  animations: [stagger40ms, scaleIn400ms, fadeInRight400ms]
})
export class ComisionesCierresShowDetailsComponent implements OnInit {
  navLinks = Array();
  currentId = Number;
  comision: Comision;
