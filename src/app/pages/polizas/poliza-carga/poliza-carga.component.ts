...
@Component({
  selector: 'vex-poliza-carga',
  templateUrl: './poliza-carga.component.html',
  styleUrls: ['./poliza-carga.component.scss']
})
export class PolizaCargaComponent implements OnInit {
