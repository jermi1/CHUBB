...
@Component({
  selector: 'vex-renovaciones-data-table',
  templateUrl: './renovaciones-data-table.component.html',
  styleUrls: ['./renovaciones-data-table.component.scss'],
  providers: [
    {
...
export class RenovacionesDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: Renovacion['id']) {
