...
@Component({
  selector: 'vex-ajustadores-data-table',
  templateUrl: './ajustadores-data-table.component.html',
  styleUrls: ['./ajustadores-data-table.component.scss'],
  providers: [
    {
...
export class AjustadoresDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: Ajustador['id']) {
