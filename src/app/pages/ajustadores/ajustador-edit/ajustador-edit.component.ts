...
@Component({
  selector: 'vex-ajustador-edit',
  templateUrl: './ajustador-edit.component.html',
  styleUrls: ['./ajustador-edit.component.scss']
})


export class AjustadorEditComponent implements OnInit {
