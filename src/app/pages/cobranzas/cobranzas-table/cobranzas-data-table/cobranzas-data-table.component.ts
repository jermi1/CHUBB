...
@Component({
  selector: 'vex-cobranzas-data-table',
  templateUrl: './cobranzas-data-table.component.html',
  styleUrls: ['./cobranzas-data-table.component.scss'],
  providers: [
    {
...
export class CobranzasDataTableComponent<T> implements OnInit, OnChanges, AfterViewInit {
  ...
  emitToggleStar(event: Event, id: Cobranza['id']) {
