...
@Component({
  selector: 'vex-referenciador-show-siniestros',
  templateUrl: './referenciador-show-siniestros.component.html',
  styleUrls: ['./referenciador-show-siniestros.component.scss']
})
export class ReferenciadorShowSiniestrosComponent implements OnInit {
